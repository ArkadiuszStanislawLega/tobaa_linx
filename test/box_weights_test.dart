...
void main() {
  ...
  test("Method fill", () {
    ...
    const MAX_GROSS_WEIGHT_WHEN_FILLED = NUMBER_OF_BAA_TO_FILL_THE_BOX * BAA_WEIGHTS +
        NET_BOX_WEIGHT;

    const MAX_NET_EXPLOSIVE_WEIGHT_WHEN_FILLED = NUMBER_OF_BAA_TO_FILL_THE_BOX *
        BAA_WEIGHTS;
    ...
    expect(boxWeights.currentNetExplosive, MAX_NET_EXPLOSIVE_WEIGHT_WHEN_FILLED);
